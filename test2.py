...
# def run():
first_team_name = "Kings"
second_team_name = "Trail Blazers"
pre_game_total = 221.5
...
WebDriverWait(driver, 45).until(EC.element_to_be_clickable((By.CSS_SELECTOR, "button[aria-label=\"Consent\"]"))).click()


temp_total = 0
INDEX = 0
while(True):
    live_button = WebDriverWait(driver, 45).until(EC.element_to_be_clickable((By.CSS_SELECTOR, "div[class=\"sc-772fdc7b-0 leDECH\"]")))
    live_button.click()
    sleep(2)
